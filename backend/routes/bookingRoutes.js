...
import { createBooking, getUserBookings, updateBooking,deleteBooking,getAllBookings,adminDeleteBooking, getBookingCount, getBookingsByProperty } from "../controllers/bookingController.js";
...
router.get("/property/:id", getBookingsByProperty);
